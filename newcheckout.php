...
<?php
                  ...
                  if(mysqli_query($link,"insert into checkout(uid,pid,pname,name,email,address,quantity,price,delivery) value('$uid','$pid','$pname','$uname','$email','$addr','$quantity','$price','$delivery')"))
                  {
